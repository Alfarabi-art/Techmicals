...
if selected == "🏠 Home":
    ...
    col1, col2, col3 = st.columns(3)
    with col1:
        st.markdown("<div class='feature-card'><h4>👩‍🔬 Azkia Nadira Azmi</h4><p>2460341</p></div>", unsafe_allow_html=True)
        st.markdown("<div class='feature-card'><h4>👨‍🔬 Hanif Zaki Abizar</h4><p>2460384</p></div>", unsafe_allow_html=True)
    with col2:
        st.markdown("<div class='feature-card'><h4>👩‍🔬 Muhammad Al Farabi</h4><p>2460430</p></div>", unsafe_allow_html=True)
    with col3:
        st.markdown("<div class='feature-card'><h4>👨‍🔬 Ovalia Kareva Betaubun</h4><p>2460478</p></div>", unsafe_allow_html=True)
        st.markdown("<div class='feature-card'><h4>👨‍🔬 Widya Aulia Putri</h4><p>2460534</p></div>", unsafe_allow_html=True)
